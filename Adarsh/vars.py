...
class Var(object):
    ...
    name = str(getenv('name', 'filetolinot'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'shortnfly.com')) if not ON_HEROKU or getenv('FQDN', 'poscg-sonukumarkrbbu65.koyeb.app/') else APP_NAME+'.herokuapp.com'
    ...
    BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1001813214602")).split())) 
